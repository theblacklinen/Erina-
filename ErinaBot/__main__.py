...
from ErinaBot.modules import ALL_MODULES
from ErinaBot.modules.helper_funcs.chat_status import is_user_admin
from ErinaBot.modules.helper_funcs.alternate import typing_action
from ErinaBot.modules.helper_funcs.misc import paginate_modules
...
START_MSG = "*Ara Ara* I am well and alive ;)"

HELP_IMG = "https://te.legra.ph/file/3a8aee51f556a03c76976.jpg"
START_IMG = "https://te.legra.ph/file/69fd71cef9ab670643360.jpg"
    
PM_START_TEXT = """
  ⫸ [Nakiri Erina](https://te.legra.ph/file/69fd71cef9ab670643360.jpg) ⫷
Konnichiwa, I am {}
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ErinaBot.modules." + module_name)
...
def ErinaBot_callback_data(update, context):
    query = update.callback_query
    uptime = get_readable_time((time.time() - StartTime))
    if query.data == "ErinaBot_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                     InlineKeyboardButton(text="⫷", callback_data="ErinaBot_prev"),
                    InlineKeyboardButton(text="Back", callback_data="ErinaBot_back"),
                     InlineKeyboardButton(text="⫸", callback_data="ErinaBot_next")
                 ]
                ]
            ),
        )
    elif query.data == "ErinaBot_back":
        first_name = update.effective_user.first_name
        query.message.edit_text(
                PM_START_TEXT.format(
                    escape_markdown(context.bot.first_name),
...
def main():
    ...
    data_callback_handler = CallbackQueryHandler(ErinaBot_callback_data, pattern=r"ErinaBot_", run_async=True)
    ...
    if WEBHOOK:
        ...
        LOGGER.info(f"ErinaBot started, Using long polling. | SUPPORT: [@{SUPPORT_CHAT}]")
