...
from ErinaBot import ALLOW_EXCL, CustomCommandHandler, dispatcher, BOT_NAME
...
from ErinaBot.modules.sql import cleaner_sql as sql
...
*Following are* [Disasters](https://t.me/SungJinWooupdates/19) *only commands, admins cannot use these:*
