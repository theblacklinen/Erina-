...
from ErinaBot .modules.helper_funcs.extraction import extract_user_and_text
...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if message.reply_to_message and message.reply_to_message.sender_chat:
        if r := bot.ban_chat_sender_chat(
            ...
            message.reply_text(
                f"Channel {html.escape(message.reply_to_message.sender_chat.title)} was removed from {html.escape(chat.title)}",
                parse_mode="html",
            )
