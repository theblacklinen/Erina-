...
import ErinaBot.modules.sql.userinfo_sql as sql
from ErinaBot import DEV_USERS
...
@ErinaBotcmd(command='me', pass_args=True)
...
@ErinaBotcmd(command='bio', pass_args=True)
def about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if (
            ...
            message.reply_text(
                "I only trust The Emperor or Elite Ten to set my bio."
            )
            return
