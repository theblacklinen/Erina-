...
import ErinaBot.modules.sql.global_bans_sql as sql
from ErinaBot.modules.sql.users_sql import get_user_com_chats
...
from ErinaBot.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from ErinaBot.modules.helper_funcs.misc import send_to_list
...
def gban(update: Update, context: CallbackContext):
    ...
    if int(user_id) in DRAGONS:
        message.reply_text(
            "I spy, with my little eye... A-Rank Hunters! Why are you guys turning on each other?",
        )
        return
