...
import ErinaBot.modules.sql.connection_sql as sql

from ErinaBot import dispatcher, DRAGONS, DEV_USERS
from ErinaBot.modules.helper_funcs import chat_status
